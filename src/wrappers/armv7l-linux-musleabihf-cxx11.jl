# Autogenerated wrapper script for ViennaRNA_jll for armv7l-linux-musleabihf-cxx11
...
function __init__()
    JLLWrappers.@generate_init_header(MPFR_jll, GSL_jll, CompilerSupportLibraries_jll, LAPACK_jll, OpenBLAS_jll)
